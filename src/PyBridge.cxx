...
PYBIND11_MODULE(permuto_sdf, m) {
    ...
    .def("compute_exact_nr_samples_cpu", &RaySamplesPacked::compute_exact_nr_samples_cpu ) 
    .def("compute_exact_nr_rays_valid_cpu", &RaySamplesPacked::compute_exact_nr_rays_valid_cpu ) 
    .def("compute_exact_nr_samples_gpu", &RaySamplesPacked::compute_exact_nr_samples_gpu ) 
    .def("compute_exact_nr_rays_valid_gpu", &RaySamplesPacked::compute_exact_nr_rays_valid_gpu ) 
    ...
    .def("enqueue_getting_exact_nr_samples", &RaySamplesPacked::enqueue_getting_exact_nr_samples ) 
    .def("enqueue_getting_exact_nr_rays_valid", &RaySamplesPacked::enqueue_getting_exact_nr_rays_valid ) 
    .def("wait_and_get_exact_nr_samples", &RaySamplesPacked::wait_and_get_exact_nr_samples ) 
    .def("wait_and_get_exact_nr_rays_valid", &RaySamplesPacked::wait_and_get_exact_nr_rays_valid ) 
    .def("compact_given_exact_nr_samples", &RaySamplesPacked::compact_given_exact_nr_samples ) 
    .def_readwrite("m_nr_rays",  &RaySamplesPacked::m_nr_rays )
    .def_readwrite("is_compact",  &RaySamplesPacked::is_compact )
