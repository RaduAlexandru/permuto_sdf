    ...
    while True:
        ...
        if phase.iter_nr%100==0 or phase.iter_nr==1 or ngp_gui.m_control_view:
            with torch.set_grad_enabled(False):
                ...
                ray_end, ray_end_sdf, ray_end_gradient, traced_samples_packed=sphere_trace(15, ray_origins, ray_dirs, model, return_gradients=True, sdf_multiplier=0.7, sdf_converged_tresh=0.005, time_val=ngp_gui.m_time_val)
