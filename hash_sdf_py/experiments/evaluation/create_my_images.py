...
#For this script the checkpoints are in ./hash_sdf_py/scripts_for_paper/list_of_checkpoints.py
...
###CALL with 
# ./hash_sdf_py/experiments/evaluation/create_my_images.py --dataset dtu --comp_name comp_1  [--with_mask]
