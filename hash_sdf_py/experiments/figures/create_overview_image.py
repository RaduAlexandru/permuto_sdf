...
###CALL with 
# ./hash_sdf_py/experiments/figures/create_overview_image.py 
...
from hash_sdf_py.utils.common_utils import map_range_tensor
from hash_sdf_py.utils.common_utils import map_range_np
...
from hash_sdf_py.utils.common_utils import nchw2lin
from hash_sdf_py.utils.common_utils import lin2nchw
from hash_sdf_py.utils.sdf_utils import extract_mesh_from_sdf_model
from hash_sdf_py.utils.hashsdf_utils import load_from_checkpoint
from hash_sdf_py.train_hashsdf import run_net_in_chunks
...
def make_camera_frustum(idx, res_multiplier):
    ...
    if idx==0: #captured at   3.4534 0.776799  0.23304 -0.0880444   0.670344  0.0805919 0.732372   0.630147  0.0852987 -0.0170724 30 0.0648786 6487.86
        ...
        img_mat=Mat("/media/rosu/Data/phd/c_ws/src/hash_sdf/recordings/overview/img1_crop_shift.png")
        ...
        ray_dist=1.5
        #get color from a mat
        img_mat=Mat("/media/rosu/Data/phd/c_ws/src/hash_sdf/recordings/overview/img2_crop.png")
