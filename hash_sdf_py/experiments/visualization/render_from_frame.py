...
# ./hash_sdf_py/experiments/visualization/render_from_frame.py --dataset dtu --scene dtu_scan63 --comp_name comp_1  [--with_mask]
...
def run():
    ...
    #get the results path which will be at the root of the hash_sdf package 
