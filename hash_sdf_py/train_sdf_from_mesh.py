...
def run():
    ...
    while True:
        ...
        cb.after_forward_pass(loss=loss.item(), loss_rgb=0, loss_sdf_surface_area=0, loss_eikonal=0, loss_curvature=0, loss_sdf_grad=0, neus_variance_mean=0, phase=phase, lr=optimizer.param_groups[0]["lr"]) #visualizes the prediction 
